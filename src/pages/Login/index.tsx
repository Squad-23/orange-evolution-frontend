      ...
      <div className="flex mx-[31.8125rem] bg-dominant-100 h-[34.375rem] rounded-2xl py-10 box-border shadow-[10px_13px_8px_rgba(0,0,0,0.2)]">
        ...
        <form action="" className="flex flex-col px-8 ">
          ...
          <span className="">
            ...
            <div className="pb-4"> 
              <span className="text-contrast-200 text-base font-semibold">Email</span>
              <input type='email' className="mt-2 bg-dominant-200 rounded-[0.25rem] w-[22.375rem] border border-gray-400 py-2 px-2 focus:outline-none" placeholder="user@email.com"/>
            </div>

            <div>
              <span className="text-contrast-200 font-semibold">Password</span>
              <input type='password' className="mt-2 bg-dominant-200 rounded-[0.25rem] w-[22.375rem] border border-gray-400 text-contrast-200 py-2 px-2 focus:outline-none" placeholder="•••••••••••"/>
            </div>
