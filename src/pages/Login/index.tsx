...
export function Login() {
  ...
  return (
    <div className="bg-gradient-to-t from-[#ff3200] to-[#ffa000] w-screen h-screen flex flex-col gap-4 items-center justify-center">
      <h1 className="text-white text-5xl font-black">Orange Evolution </h1>
        <div className="m-5 p-5 box-border">
          <div className="h-full">
            <div className="bg- backdrop-blur w-max rounded-3xl overflow-hidden p-77-55-33-95 shadow-xl">
              ...
              <form className="w-full p-10">
                ...
                <div className="w-full relative border-orange-700 bottom-2 border-solid mb-3">
                  <input 
                    className="bg-white mt-8 top-5 rounded-sm ml-3"
                    type="email"
                    
                    />
                    <span className="absolute block w-full h-full top-0 left-0 pointer-events-none" data-placeholder="Email">Email </span>
              </div>
              ...
              <div className="w-full relative mb-3">
                <input 
                  ...
                  />
                <span className="absolute block top-0 left-0 pointer-events-none" data-placeholder="Password"> Senha </span>
              </div>
