        ...
        <div className="flex mx-[31.8125rem] bg-dominant-100 absolute h-[34.375rem] rounded-2xl py-10 box-border shadow-[10px_13px_8px_rgba(0,0,0,0.2)]">
          <form action="" className="flex flex-col px-8 ">
            ...
            <div className="pb-4">
              ...
              <input
                type="email"
                className="mt-2 bg-dominant-200 rounded-[0.25rem] w-[22.375rem] border-gray-400 border-[2px] py-2 px-2 focus:outline-none"
            ...
            <div>
              ...
              <input
                type="password"
                className="mt-2 bg-dominant-200 rounded-[0.25rem] w-[22.375rem] border-[2px] border-gray-400 text-contrast-200 py-2 px-2 focus:outline-none"
                placeholder="•••••••••••"
              />
            </div>

            <button type="button" className="underline text-[#267CBC] text-left my-6 align-center">
              {' '}
              Esqueci minha senha
            </button>
            ...
            <button
              type="button"
              className="w-[22.375rem] h-12 bg-[#00C19C] rounded-2xl text-xl text-gray-50 font-semibold"
            >
              Fazer login
            </button>
          </form>
